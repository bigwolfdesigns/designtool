...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/main.dwt.php" codeOutsideHTMLIsLocked="false" -->
	<head>
		...
		<title>Videos Automatic Feed Screwdriver - Design Tool</title>
		<meta name="description" content="Design Tool Inc.  Manufacturer of screw feeding & screw driving machines.  Ergonomic hand tools including automatic nail guns, escutcheon pin guns.  Multiple spindle drills, screw feeders, & multiple spindle heads.  Automated nailers and screwdrivers">
			...
			<!-- InstanceEndEditable --><!-- InstanceParam name="Request_Quote" type="boolean" value="true" --><!-- InstanceParam name="leftnav" type="boolean" value="true" -->
	</head>
	<body<?PHP if(isset($errors) && count($errors)){
...
?>
											...
											<td><!-- InstanceBeginEditable name="content" -->
												<table width="100%" border="0" cellspacing="0" cellpadding="4">
													<tr height="315">
														<td align="left" valign="top" width="637" height="315">
															<script type="text/javascript">
																AC_FL_RunContent('codebase', 'http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0', 'width', '637', 'height', '315', 'src', 'DTI_VIDEOS', 'quality', 'high', 'pluginspage', 'http://www.macromedia.com/go/getflashplayer', 'movie', 'DTI_VIDEOS'); //end AC code
															</script>
															<noscript>
																<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="637" height="315">
																	<param name="movie" value="DTI_VIDEOS.swf" />
																	<param name="quality" value="high" />
																	<embed src="DTI_VIDEOS.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="637" height="315"> 
																</object>
															</noscript>
														</td>
													</tr>
